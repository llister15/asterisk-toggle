...
$( document ).ready(function() {
		        	...
		        	if ( 'options' === key ) {
		        			...
		        			for(let option in optionsObj )
		        			{
		        				$('#option-table tbody tr:last-child').after( '<tr><th scope="row"><div class="form-check">\
		        					<input class="form-check-input" type="radio" id="'+option+'-radio" name="'+option+'-selection" value="'+option+'" >\
	...
	$('#add-option-btn').click(function( event ) {
		...
		$('#option-table tbody tr:last-child').after( '<tr><th scope="row"><div class="form-check">\
			<input class="form-check-input" type="radio" id="'+newOptionName+'-radio" name="'+newOptionName+'-selection" value="'+newOptionName+'" >\
		...
		setTimeout( function() { $( '#' + newOptionName ).focus(); },800 );
